...
namespace Leap.Unity.Examples
{
    ...
    public class PinchStrokeProcessor : MonoBehaviour
    {
        ...
        // chat gpt code 
        [SerializeField, Tooltip("Speed of color change")]     
        ...
        {        
            ...
            if (_ribbonMaterial != null)   {           
                _ribbonMaterial.color = currentColor;        
            }  
            //update all child materials;
            var childrenMat = _ribbonParentObject.GetComponentsInChildren<Renderer>();
            foreach(var mat in childrenMat){
                mat.materials[0].color = currentColor;
            }
        }
